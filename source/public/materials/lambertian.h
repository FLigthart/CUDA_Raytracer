...
public:
	...
	__device__ bool inline scatter(const Ray& r_in, const HitInformation& hitInformation, color4& attenuation, curandState* randomState, Ray& scattered) const override;
...
__device__ bool lambertian::scatter(const Ray& r_in, const HitInformation& hitInformation, color4& attenuation, curandState* randomState, Ray& scattered) const
{
